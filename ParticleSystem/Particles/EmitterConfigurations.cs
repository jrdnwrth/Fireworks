...
public static class EmitterConfigurations
{
    ...
    public static List<Emitter> CreateFireworkEmitters(int screenWidth, int screenHeight)
    {
        ...
        var upwardEmitter = new Emitter
        {
            ...
            initial_lifetime = 3.5f,                        // Emitter lives for 3.5 seconds
            EmissionTimer = 0f,
        ...
        var upwardEmitter2 = new Emitter
        {
            ...
            initial_lifetime = 4.5f,                        // Emitter lives for 4.5 seconds
            EmissionTimer = 0f,
        ...
        var upwardEmitter3 = new Emitter
        {
            ...
            initial_lifetime = 2.5f,                        // Emitter lives for 2.5 seconds
            EmissionTimer = 0f,
        ...
        var upwardEmitter4 = new Emitter
        {
            ...
            initial_lifetime = 3f,                          // Emitter lives for 3 seconds
            EmissionTimer = 0f,
